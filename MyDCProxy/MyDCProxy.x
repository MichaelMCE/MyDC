...
FUNCTION DllStartup (TDCPlugin dcp)
	...
	PluginTitle = "MyDC Proxy Server by Michael McE (port "+STRING$(Listen_Port)+")"
	dcp.lpPluginTitle = &PluginTitle
	#hThread = _beginthreadex (NULL, 0, &Main(), 0, 0, &tid)
...
FUNCTION Main (arg)
	...
	#hSemListen = CreateSemaphoreA (NULL,0,1,NULL)
	...
	DO UNTIL (#SHUTDOWN  == $$TRUE)
		...
		IF client THEN
			...
			#htdListen = _beginthreadex (NULL, 0, &ListenMsg(), client, 0, &tid)
...
FUNCTION DllProc (token, STRING msg1, STRING msg2)
	...
	SELECT CASE token
		CASE $$MDCT_ClientJoinAll	:SendDCTMsg (token, @msg1, @msg2)
		CASE $$DCT_Search			:SendDCTMsg (token, @msg1, @msg2)
		CASE $$DCT_Quit				:SendDCTMsg (token, @msg1, @msg2)
		...
		CASE $$MDCT_ClientConnected	:SendDCTMsg (token, msg1, msg2)
		CASE $$MDCT_PubCmdMsg		:SendDCTMsg (token, @msg1, @msg2)
		CASE $$MDCT_PrvTxtMsg		:SendDCTMsg (token, @msg1, @msg2)
		...
		CASE $$MDCT_NickList		:SendDCTMsg (token, @msg1, @msg2)
		CASE $$MDCT_NickListTotal	:SendDCTMsg (token, msg1, msg2)
		CASE $$MDCT_HubShareTotal	:SendDCTMsg (token, msg1, msg2)
		CASE $$MDCT_HubUsers		:SendDCTMsg (token, @msg1, @msg2)
		CASE $$DCT_HubINFO			:SendDCTMsg (token, @msg1, @msg2)
		CASE $$DCT_HubName			:SendDCTMsg (token, @msg1, @msg2)
		CASE $$MDCT_MyShareSize		:SendDCTMsg (token, msg1, msg2)
		CASE $$MDCT_ClientOpJoin	:SendDCTMsg (token, msg1, msg2)
		CASE $$MDCT_IntNickList		:SendDCTMsg (token, @msg1, @msg2)
		...
		CASE $$MDCT_Plugin			:SendDCTMsg (token, msg1, msg2)
...
FUNCTION ListenMsg (socket)
	...
	LOOP WHILE (CONNECTED == $$TRUE) AND (#SHUTDOWN == $$FALSE)
